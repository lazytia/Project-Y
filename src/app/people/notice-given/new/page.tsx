...
/* ─────────────────────────────────────────────────────────────────────────
 * Notice Given — Add form.
 * Saves a record to the `notice_given` Firestore collection.
 * ───────────────────────────────────────────────────────────────────────── */
...
export default function NoticeGivenNewPage() {
  ...
  // lastWorkingDay removed from UI — still saved as empty string for schema compat
  ...
  // calLastDayOpen removed (Last Working Day field removed)
  ...
  async function handleSave() {
    ...
    setSaving(true);
    try {
      await addDoc(collection(getDb(), "notice_given"), {
  ...
  return (
    <div className={styles.page}>
      ...
      <header className={styles.header}>
        ...
        <button type="button" className={styles.iconBtn} aria-label="Info">
      ...
      <div className={styles.saveWrap}>
        ...
        <p className={styles.saveHint}>
          This will update the employee status to Notice Given.
        </p>
      </div>
